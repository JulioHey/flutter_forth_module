    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider<AuthProvider, OrdersProvider>(
          ...
          update: (ctx, authProvider, previousProducts) => OrdersProvider(
            authProvider.token,
            previousProducts.orders == null ? [] : previousProducts.orders,
            authProvider.userId
          ),
        ),
      ],
          ...
          home: authData.isAuth ? ProductsOverviewScreen() : 
            FutureBuilder(
              ...
              builder: (ctx, authResult) => 
                authResult.connectionState == ConnectionState.waiting ? SplashScreen()
                : AuthScreen()
            ),
          routes: {
