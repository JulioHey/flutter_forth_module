...
//    var url = Uri.https('flutter-shop-app-d8fdf-default-rtdb.firebaseio.com', '/products.json?auth=$authToken');
...
class ProductsProvider with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    ...
    try {
      ...
      url = Uri.parse('https://flutter-shop-app-d8fdf-default-rtdb.firebaseio.com/userFavorite/$userId.json?auth=$authToken');
  ...
  Future<void> addProduct(Product product) async {
    final url = Uri.parse('https://flutter-shop-app-d8fdf-default-rtdb.firebaseio.com/products.json?auth=$authToken');
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    final prodIndex = _items.indexWhere((prod) => prod.id == id);
    if (prodIndex >= 0) {
      final url = Uri.parse('https://flutter-shop-app-d8fdf-default-rtdb.firebaseio.com/products$id.json?auth=$authToken');
